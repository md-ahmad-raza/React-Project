...
const Home = () => {
  ...
  const carouselImages = [
    { src: "image1.png", caption: "Access World-Class Specialists Without Leaving Home" },
    ...
    { src: "image5.jpg", caption: "Expert Consultations from the Comfort of Your Home" },
  ...
  <div className="topdoctors-container">
    {TopDoctors.map((doctor, index) => (
      <div className="topdoctors-card" key={index}>
        <img src={doctor.image} alt={doctor.name} className="topdoctors-image" />
